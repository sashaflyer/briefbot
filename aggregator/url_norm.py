...
with vs without utm_* tracking params) should compare equal so the same
item is not re-delivered.
"""
...
def canonicalize(url: str) -> str:
    ...
    Drops fragments, normalizes host case, strips tracking query params,
    lowercases scheme, and collapses trailing slashes on the path.
